...
- [DEV_260430.md](DEV_260430.md) — **YouTube 요약 처리 성능 개선** / **fetch-transcript timedtext API 전환 + hnd1 리전** (iad1 IP 차단 우회 시도) / **세션 타이틀 생성 1·2·3차 개선**: 프롬프트 5단어→5~15단어, 마크다운 strip + URL strip, 첫 줄만 추출, maxOutputTokens 120→400, `thinkingBudget: 0`으로 thinking 비활성화(단어 중간 잘림 근본 해결)
