...
>
> **2026-09-22 측정 완료 — 기본 모델 현행 유지:** 3.6·3.7·3.8을 두 축으로 342회 쟀다([DEV_260922](../logs/2026/09/DEV_260922.md)).
> 비검색 생성 252회·검색 grounding 90회가 **전부 통과해 정답률이 무승부**다. 지연은 3.6이 가장 빨랐고,
> 이진 채점 밖의 변별은 단일 `$` 누출(3.6만 4/84) 하나뿐이다. **3.6을 내릴 근거도 3.8을 올릴 근거도 없다.**
