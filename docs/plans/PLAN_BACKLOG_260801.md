...
- 🔴 **승격 조건 (2026-08-08 배포 검증 후 추가)**: 6.5MB PDF 가 화면에서 통과는 했으나 **체감상 느렸고 실제 소요 시간을 재지 못했다**([DEV_260808 §5-3](../logs/2026/08/DEV_260808.md)). 측정해서 **40s 대가 나오면 이 항목은 대기가 아니라 선결 과제**가 된다 — 조금 더 큰 문서나 느린 시간대엔 그대로 60s 캡에 잘린다. 통과 여부가 아니라 **여유**가 판단 기준이다.
